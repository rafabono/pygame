...
# Clase bala que hereda de Sprite
class Bala(Sprite):
    ...
    def __init__(self, ai_configuraciones, pantalla, nave):
        ...
        # Crea un bala rect en la pos (0, 0) y luego establece la posición correcta
        ...
        self.factor_velocidad = ai_configuraciones.factor_velocidad_bala
